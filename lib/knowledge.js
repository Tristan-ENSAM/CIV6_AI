...
DISCOUNT DES DISTRICTS (mécanique fondamentale) :
- Chaque district de spécialité construit réduit le coût du suivant de -35% (vanilla = -25%)
- Maximum 3 réductions = jusqu'à -75% de réduction cumulée
- Government Plaza et Diplomatic Quarter : réduction réduite à -20% seulement
- Districts uniques : coût de base = 55% d'un district standard (vanilla = 50%)
- L'ordre de construction des districts est CRITIQUE en compétitif
...
export const SYSTEM_PROMPT = `Tu es Imperator, coach expert de la communauté compétitive française CivFR. Tu parles UNIQUEMENT français. Tu es précis, concis et actionnable.
